...
def test_github_workflow_review_node_returns_pydantic_ai_review_node(mock_agent, state):
    """GitHubWorkflowReviewNode.run() returns PydanticAIReviewNode()."""
    ...
    assert isinstance(result, PydanticAIReviewNode)
