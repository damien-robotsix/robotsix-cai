...
| `.claude/agents/cai-maintain.md` | Agent: execute maintenance operations from kind:maintenance issues |
...
| `tests/test_maintain.py` | Tests for maintenance operations execution and state transitions |
