---
name: cai-select
description: Evaluate multiple fix plans for an auto-improve issue and select the best one. Called via Anthropic API with forced tool-use to return a structured selection (plan, confidence, optional note).
tools: None
