...
2. **Dive deep:** Dive into specific failing traces or long-running workflows using `traces_show` with `analyze=True`. Use `full=True` if you need to understand the exact inputs/outputs of failing tools.
