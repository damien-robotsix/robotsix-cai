...
- **Module size**: Files significantly over 300 lines should be split into smaller, single-purpose modules — even files with a single concern become hard to navigate, review, and test when they grow too large. Files that have grown through accretion rather than design.. Files that have grown through accretion rather than design.
