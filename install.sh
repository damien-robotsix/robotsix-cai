...
alias cai='${DC} exec cai claude --dangerously-skip-permissions'
alias cai-cycle='${DC} exec cai python /app/cai.py cycle'
alias cai-audit='${DC} exec cai python /app/cai.py audit'
alias cai-analyze='${DC} exec cai python /app/cai.py analyze'
alias cai-dispatch='${DC} exec cai python /app/cai.py dispatch'
alias cai-verify='${DC} exec cai python /app/cai.py verify'
alias cai-cost='${DC} exec cai python /app/cai.py cost-report'
alias cai-health='${DC} exec cai python /app/cai.py health-report --dry-run'
alias cai-logs='${DC} logs -f cai'
alias cai-exec='${DC} exec cai'
ALIASES
)
    ...
    *)
      ...
      echo "  alias cai='${DC} exec cai claude --dangerously-skip-permissions'"
      echo "  alias cai-cycle='${DC} exec cai python /app/cai.py cycle'"
      echo "  alias cai-audit='${DC} exec cai python /app/cai.py audit'"
      ;;
  esac
