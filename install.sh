...
# Auth mode: in-container claude /login (OAuth in cai_claude volume)
services:
  cai:
    ...
    volumes:
      ...
      #     docker compose run --rm cai claude /login
...
YAML
    ...
    echo
    echo "Next: authenticate to Claude inside the container."
    echo "  Run: docker compose run --rm cai claude /login"
    ;;
  2)
